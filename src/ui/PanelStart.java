...
public class PanelStart extends JPanel implements Runnable{
	...
	public void drawGif(Graphics g){
		...
		if(loadButton.isIn==false){
			...
			PicturePlayer pic2 = new PicturePlayer(picture2, true, 7);
		...
		if(exitButton.isIn1==false){
			...
			PicturePlayer pic3 = new PicturePlayer(picture3, true, 7);
		...
		if(setButton.isIn==false){
			...
			PicturePlayer pic4 = new PicturePlayer(picture4, true, 7);
		...
		if(classicButton.isIn==false){
			...
			PicturePlayer pic5 = new PicturePlayer(picture5, true, 7);
		...
		if(netButton.isIn==false){
			...
			PicturePlayer pic6 = new PicturePlayer(picture6, true, 7);
